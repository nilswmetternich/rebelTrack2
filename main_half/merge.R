...
load('~/Dropbox/elements/coala/rebelCast/ged_panel_halfyear.rda')
test.1 <- dim(ged_panel)[1]

#merge rebel_best
load('~/Dropbox/elements/coala/rebelCast/ucdp_best_halfyear.rda')
ged_panel <- left_join(ged_panel,ucdp_best)
ged_panel$best[is.na(ged_panel$best)] <- 0

#merge rebel_days
load('~/Dropbox/elements/coala/rebelCast/ucdp_days_halfyear.rda')
ged_panel <- left_join(ged_panel,ucdp_days)
ged_panel$days[is.na(ged_panel$days)] <- 0

#merge deaths_a
load('~/Dropbox/elements/coala/rebelCast/ucdp_deaths_a_halfyear.rda')
ged_panel <- left_join(ged_panel,ucdp_deaths_a)
ged_panel$deaths_a[is.na(ged_panel$deaths_a)] <- 0

#merge deaths_b
load('~/Dropbox/elements/coala/rebelCast/ucdp_deaths_b_halfyear.rda')
ged_panel <- left_join(ged_panel,ucdp_deaths_b)
ged_panel$deaths_b[is.na(ged_panel$deaths_b)] <- 0

#merge rebel_distance
load('~/Dropbox/elements/coala/rebelCast/ucdp_distance_halfyear.rda')
...
#merge rebel_events
load('~/Dropbox/elements/coala/rebelCast/ucdp_events_halfyear.rda')
ged_panel <- left_join(ged_panel,ucdp_events)
ged_panel$events[is.na(ged_panel$events)] <- 0


#merge rebel_grids
load('~/Dropbox/elements/coala/rebelCast/ucdp_grids_halfyear.rda')
ged_panel <- left_join(ged_panel,ucdp_grids)
ged_panel$grids[is.na(ged_panel$grids)] <- 0

#merge rebel_transnational
load('~/Dropbox/elements/coala/rebelCast/transnational_ratio_halfyear.rda')
...
save(ged_merge, file='~/Dropbox/elements/coala/rebelCast/ged_merge_halfyear.rda')
