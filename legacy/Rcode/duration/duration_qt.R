...
data.org.temp$time.to.end <- rev(1:dim(data.org.temp)[1])

data.org.temp$end <- 0	

data.org.temp$end <- ifelse(data.org.temp$datum==as.yearqtr(max.date),1,0)	

data.org.temp$end[data.org.temp$end==1 & data.org.temp$datum>as.yearqtr("2014-12-31")] <- 0
...
save(org.duration,file="~/Documents/git/rebelTrack/Rcode/duration/org.duration.qt.rda")
