#' Actors active per Priogrid_gid
#'
...
#'                              balanced = TRUE)
#'
#' data <- rebeltrack_gid_actors_active(data, actors_active)
#' }
#' @export
rebeltrack_actors_active_gid <- function(x, var, fill = 0, lag = 0, weight = NULL) {
