#' Transnational Ratio
#'
#' Ratio of events in the grids's country and all other countries
#'
...
#'                              balanced = TRUE)
#'
#' data <- rebeltrack_transnational_ratio_gid(data, transnational_ratio)
#' }
#' @export
rebeltrack_transnational_ratio_gid <- function(x, var, fill = 0, lag = 0,
                                           weight = NULL) {
