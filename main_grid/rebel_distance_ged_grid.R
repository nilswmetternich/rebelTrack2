...
ucdp_distance_grid$mean.bdist3[is.na(ucdp_distance_grid$mean.bdist3)]	<- 	max(ucdp_distance_grid$mean.bdist3,na.rm=TRUE)
ucdp_distance_grid$mean.capdist[is.na(ucdp_distance_grid$mean.capdist)] <- max(ucdp_distance_grid$mean.capdist,na.rm=TRUE)			

save(ucdp_distance_grid, file='~/Dropbox/elements/coala/rebelCast/ucdp_distance_grid.rda')
